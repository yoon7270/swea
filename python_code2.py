...
while True:
    ...
    # 기억상 코드
    halls = [(),(2,125) , (127,125) , (252,125) , (2,2) , (127,2) , (252,2)]
    hall_x , hall_y = halls[3]
    dx , dy = hall_x - targetBall_x , hall_y - targetBall_y
    d = math.hypot(dx,dy)
    ax , ay = targetBall_x - dx / d - 5.73 , targetBall_y - dy / d - 5.73

    angle = (180 / math.pi * math.atan2(ax - whiteBall_x , ay - whiteBall_y)) % 360
    power = distance * 0.5
